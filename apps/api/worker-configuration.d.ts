/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1b8a47e8f46ebc45773ee7aeb53f431f)
// Runtime types generated with workerd@1.20260617.1 2026-04-08 nodejs_compat
interface __BaseEnv_Env {
	MCP_SESSIONS: KVNamespace;
	MAPLE_DB: Hyperdrive;
	VCS_SYNC_QUEUE: Queue;
	LOADER: WorkerLoader;
	AUTUMN_PROD_SECRET_KEY: string;
	AUTUMN_SECRET_KEY: string;
	CODEMODE_RUNTIME: DurableObjectNamespace<import("./src/worker").CodemodeRuntimeDO>;
	SELF: Service<typeof import("./src/worker").default>;
	CLICKHOUSE_SCHEMA_APPLY_WORKFLOW: Workflow<Parameters<import("./src/worker").ClickHouseSchemaApplyWorkflow['run']>[0]['payload']>;
	AI_TRIAGE_WORKFLOW: Workflow<Parameters<import("./src/worker").AiTriageWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "CodemodeRuntimeDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTUMN_PROD_SECRET_KEY" | "AUTUMN_SECRET_KEY">> {}
}
